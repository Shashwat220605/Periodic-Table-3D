        ...
        <section className="trends-page">
          ...
          <div className="trend-card">
            <div className="trend-card-top">
              <div><span className="trend-property-label">CURRENT PROPERTY</span><strong>{trend.label}</strong></div>
              <div className="trend-scale"><span>LOW</span><div className="scale-bar" /><span>HIGH</span></div>
            </div>
          ...
          {hovered && (
            <div className="trend-inspector">
              ...
              <div><span>{hovered.name}</span><strong>{getTrendValue(hovered, trendKey) == null ? "Data unavailable" : trend.format(getTrendValue(hovered, trendKey))}</strong></div>
              <button onClick={() => selectElement(hovered)}>EXPLORE ATOM →</button>
            </div>
          )}
        </section>
      )}
